...
CConProperties::CConProperties(CWnd *pParent /*=NULL*/)
	: CDialog(CConProperties::IDD, pParent), m_strPassword(_T("")), m_strUserName(_T("")), m_dwIPAddress(0), m_dwIPAddress1(0), m_uiPort1(0), m_uiPort(0), m_dwBufferSize(0), m_strIPs(_T(""))
{
}
/////////////////////////////////////////////////////////////////////////////////////
