...
CNQTVOptions::CNQTVOptions(CWnd* pParent /*=NULL*/)
	: CDialogEx(CNQTVOptions::IDD, pParent)
	, m_dwSystemEvent(0)
	, m_dwSystemDirectory(0)
	, m_dwStockTradingAction(0)
	, m_dwSHORestriction(0)
	, m_dwMarketMakerPosition(0)
	, m_dwMWCBDLM(0)
	, m_dwIPOQuotation(0)
	, m_dwNOII(0)
	, m_dwRPPI(0)
	...
	, m_dwTradeNonCross(0)
	, m_dwAll(0)
	, m_dwAddOrderNoMPID(0)
	, m_dwAddOrderWithMPID(0)
	, m_dwOrderExecuted(0)
	, m_OrderExecWithPrice(0)
	, m_dwOrderCancel(0)
	, m_dwOrderReplace(0)
	, m_dwOrderDelete(0)
{
