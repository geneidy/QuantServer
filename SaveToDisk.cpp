...
//////////////////////////////////////////////////////////////////////////////////////////
//int CSaveToDisk::WriteFeedToFile(char cMessageType, ITCH_MESSAGES_UNION MessageToWrite)
int CSaveToDisk::WriteFeedToFile()
{
  ...
  pItchMessageUnion = (ITCH_MESSAGES_UNION*) m_pQuantQueue->Dequeue(&iMessage);
  if (pItchMessageUnion == NULL)
    return 0;
  
  m_DiskMessage.uiTCH_MESSAGE = *pItchMessageUnion;
  
  m_DiskMessage.uiMessageSequence = m_ui64WriteSequence++;
  m_DiskMessage.cMessageType = iMessage;

  
//  write(m_iHandle, (void*)(&m_DiskMessage), sizeof(QT_ITCH_MESSAGE)); 
  ssize_t iRet = write(m_iHandle, &m_DiskMessage, m_iSizeOfMessage); 
  if (iRet == -1){
    m_iError = 1;
    switch(errno) {
      case EBADF:
...
//////////////////////////////////////////////////////////////////////////////////////////////////
string CSaveToDisk::GetErrorString()
{
  m_iError = 0;
  return m_strError;
}
