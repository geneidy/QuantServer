...
SRCS = main.cpp FillMsgStructs.cpp NQTV.cpp NQTVDlg.cpp Util.cpp ReceiveITCH.cpp Logger.cpp \
ReceiveFeed.cpp ParseFeed.cpp BuildBook.cpp SaveToDB.cpp SaveToDisk.cpp  PlayBack.cpp  NasdTestFile.cpp  Distributor.cpp\
QuantQueue.cpp OrdersMap.cpp TickDataMap.cpp 
